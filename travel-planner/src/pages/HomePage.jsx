  ...
  return (
    ...
    >
      ...
      <div className="relative container mx-auto p-4 text-white flex flex-col items-center justify-center h-full w-full">
        {/* Welcome Message */}
        <h1 className="text-4xl md:text-6xl font-bold mb-2 text-center">Welcome to Globetrekker</h1>
        <p className="text-xl md:text-2xl mb-8 text-center">Find Your Destination</p>
